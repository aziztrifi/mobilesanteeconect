...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final int DATABASE_VERSION = 6; // Incremented version for the new changes
    ...
    private static final String COL_PROFILE_IMAGE_URI = "PROFILE_IMAGE_URI"; // New column for profile image URI
    ...
    private static final String CREATE_USER_TABLE =
            "CREATE TABLE IF NOT EXISTS " + TABLE_NAME_USER + " (" +
                    ...
                    COL_PROFILE_IMAGE_URI + " TEXT);"; // Added PROFILE_IMAGE_URI column
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 6) {
            db.execSQL("ALTER TABLE " + TABLE_NAME_USER + " ADD COLUMN " + COL_PROFILE_IMAGE_URI + " TEXT"); // Adding profile image URI column
        }
    }
}
